...
export const supabase = createClient(
  ...
  {
    auth: {
      flowType: 'pkce',          // best for mobile
      persistSession: true,      // keep user logged in
      autoRefreshToken: true,    // background refresh
      detectSessionInUrl: false, // we handle deep-link exchange ourselves
      storage: AsyncStorageAdapter,
    },
    // Optional: tune fetch retry behavior if your network is flaky
    global: {
      headers: {
        // add any app-wide headers here if needed
      },
    },
  }
);
